...
const workflow = [
  { step: '01', title: '选择形象', desc: '从丰富形象库选择，或定制专属数字人' },
  { step: '02', title: '生成文案', desc: 'AI 智能生成直播话术，一键优化' },
  { step: '03', title: '合成视频', desc: '选择音色，生成口播视频' },
  { step: '04', title: '下载视频', desc: '下载生成视频，即可使用' }
]
</script>
