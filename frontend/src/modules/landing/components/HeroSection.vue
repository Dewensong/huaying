...
<template>
  <section class="relative min-h-screen flex items-center justify-center pt-24 overflow-hidden">
    ...
    <!-- 背景光效 -->
    <div class="absolute inset-0 bg-gradient-to-br from-[#14B8A6]/10 via-transparent to-[#F59E0B]/10"></div>
    <div class="absolute top-1/4 left-1/4 w-[600px] h-[600px] bg-[#14B8A6]/10 rounded-full blur-[120px]"></div>
    <div class="absolute bottom-1/4 right-1/4 w-[500px] h-[500px] bg-[#F59E0B]/15 rounded-full blur-[100px]"></div>
    ...
    <div class="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
      ...
      <h1 class="text-4xl sm:text-5xl lg:text-7xl font-bold text-white mb-8 leading-tight">
        <span class="bg-gradient-to-r from-[#14B8A6] via-[#0D9488] to-[#F59E0B] bg-clip-text text-transparent">AI 数字人</span>
        <br />
      ...
      <p class="text-lg sm:text-xl text-slate-300 mb-12 max-w-3xl mx-auto leading-relaxed">
        ...
        <span class="text-[#14B8A6] font-medium">适用于电商直播、知识分享、品牌宣传</span>等多种场景。
      </p>
      ...
      <div class="relative max-w-4xl mx-auto">
        <div class="relative p-1 bg-gradient-to-r from-[#14B8A6]/30 to-[#F59E0B]/30 rounded-2xl animate-teal-amber-breathe">
...
@keyframes breathe {
  0%, 100% {
    box-shadow: 0 0 20px rgba(20, 184, 166, 0.3), 0 0 40px rgba(245, 158, 11, 0.1);
  }
  50% {
    box-shadow: 0 0 40px rgba(20, 184, 166, 0.5), 0 0 80px rgba(245, 158, 11, 0.3);
  }
}

@keyframes teal-amber-breathe {
  0%, 100% {
    box-shadow: 0 0 30px rgba(20, 184, 166, 0.2), 0 0 60px rgba(245, 158, 11, 0.1);
  }
  50% {
    box-shadow: 0 0 50px rgba(20, 184, 166, 0.4), 0 0 100px rgba(245, 158, 11, 0.2);
  }
}
